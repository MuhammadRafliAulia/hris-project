...
<div style="flex:1;display:flex;flex-direction:column;min-width:0;">
  <div style="display:flex;justify-content:center;padding:24px 20px 0;flex:1;">
    <div style="max-width:900px;width:100%;">
      ...
      <form method="POST" action="{{ route('surveys.store') }}" id="surveyForm" onsubmit="validateForm(event)">
        @csrf

        <div class="page-header">
          <div>
            <div class="page-title">📝 Buat Survey Baru</div>
            <div class="page-subtitle">Buat survey engagement karyawan</div>
          </div>
        ...
        <div class="content">
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-input" value="{{ old('title') }}" placeholder="cth: Survey Kepuasan Karyawan Q1 2026" required>
          </div>

          <div class="form-group">
            <label class="form-label">Deskripsi</label>
            <textarea name="description" class="form-textarea" placeholder="Deskripsi singkat tentang survey ini...">{{ old('description') }}</textarea>
          </div>
          ...
          <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">💾 Simpan Survey</button>
          </div>
        </div>
      </form>
    </div>
        ...
        <div class="question-header">
          ...
          <div class="q-required">
            <label class="form-check" style="font-size:11px;">
              ...
              <input type="checkbox" name="sections[${secIdx}][questions][${qIdx}][is_required]" value="1" ${q.is_required!==false?'checked':''}>
              <span>Wajib</span>
            </label>
          </div>
        </div>
